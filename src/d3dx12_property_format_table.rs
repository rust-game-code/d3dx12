...
use windows::Win32::{
    Foundation::FALSE,
    Graphics::{Direct3D::*, Dxgi::Common::*},
};

pub struct FORMAT_DETAIL {
    DXGIFormat: DXGI_FORMAT,
    ParentFormat: DXGI_FORMAT,
    pDefaultFormatCastSet: *const DXGI_FORMAT, // This is dependent on FL/driver version, but is here to save a lot of space
    BitsPerComponent: [u8; 4],                 // only used for D3DFTL_PARTIAL_TYPE or FULL_TYPE
    BitsPerUnit: u8,
    SRGBFormat: bool,
    WidthAlignment: u32,  // number of texels to align to in a mip level.
    HeightAlignment: u32, // Top level dimensions must be a multiple of these
    DepthAlignment: u32,  // values.
    Layout: D3D_FORMAT_LAYOUT,
    TypeLevel: D3D_FORMAT_TYPE_LEVEL,
    ComponentName0: D3D_FORMAT_COMPONENT_NAME, // RED    ... only used for D3DFTL_PARTIAL_TYPE or FULL_TYPE
    ComponentName1: D3D_FORMAT_COMPONENT_NAME, // GREEN  ... only used for D3DFTL_PARTIAL_TYPE or FULL_TYPE
    ComponentName2: D3D_FORMAT_COMPONENT_NAME, // BLUE   ... only used for D3DFTL_PARTIAL_TYPE or FULL_TYPE
    ComponentName3: D3D_FORMAT_COMPONENT_NAME, // ALPHA  ... only used for D3DFTL_PARTIAL_TYPE or FULL_TYPE
    ComponentInterpretation0: D3D_FORMAT_COMPONENT_INTERPRETATION, // only used for D3DFTL_FULL_TYPE
    ComponentInterpretation1: D3D_FORMAT_COMPONENT_INTERPRETATION, // only used for D3DFTL_FULL_TYPE
    ComponentInterpretation2: D3D_FORMAT_COMPONENT_INTERPRETATION, // only used for D3DFTL_FULL_TYPE
    ComponentInterpretation3: D3D_FORMAT_COMPONENT_INTERPRETATION, // only used for D3DFTL_FULL_TYPE
    bDX9VertexOrIndexFormat: bool,
    bDX9TextureFormat: bool,
    bFloatNormFormat: bool,
    bPlanar: bool,
    bYUV: bool,
    bDependantFormatCastSet: bool, // This indicates that the format cast set is dependent on FL/driver version
    bInternal: bool,
}
impl FORMAT_DETAIL {
    pub const fn new(
        ...
        Self {
            ...
            bPlanar,
            bYUV,
            bDependantFormatCastSet,
            bInternal,
        }
    }
}

pub struct D3D12_PROPERTY_LAYOUT_FORMAT_TABLE {
    s_FormatDetail: Vec<FORMAT_DETAIL>,
    s_NumFormats: u32,
    s_FormatNames: Vec<&'static str>, // separate from above structure so it can be compiled out of runtime.
}

impl D3D12_PROPERTY_LAYOUT_FORMAT_TABLE {}
...
const R: D3D_FORMAT_COMPONENT_NAME = D3DFCN_R;
const G: D3D_FORMAT_COMPONENT_NAME = D3DFCN_G;
const B: D3D_FORMAT_COMPONENT_NAME = D3DFCN_B;
const A: D3D_FORMAT_COMPONENT_NAME = D3DFCN_A;
const D: D3D_FORMAT_COMPONENT_NAME = D3DFCN_D;
const S: D3D_FORMAT_COMPONENT_NAME = D3DFCN_S;
const X: D3D_FORMAT_COMPONENT_NAME = D3DFCN_X;
const _TYPELESS: D3D_FORMAT_COMPONENT_INTERPRETATION = D3DFCI_TYPELESS;
const _FLOAT: D3D_FORMAT_COMPONENT_INTERPRETATION = D3DFCI_FLOAT;
const _SNORM: D3D_FORMAT_COMPONENT_INTERPRETATION = D3DFCI_SNORM;
const _UNORM: D3D_FORMAT_COMPONENT_INTERPRETATION = D3DFCI_UNORM;
const _SINT: D3D_FORMAT_COMPONENT_INTERPRETATION = D3DFCI_SINT;
const _UINT: D3D_FORMAT_COMPONENT_INTERPRETATION = D3DFCI_UINT;
const _UNORM_SRGB: D3D_FORMAT_COMPONENT_INTERPRETATION = D3DFCI_UNORM_SRGB;
const _FIXED_2_8: D3D_FORMAT_COMPONENT_INTERPRETATION = D3DFCI_BIASED_FIXED_2_8;
...
// // Format Cast Sets
// // --------------------------------------------------------------------------------------------------------------------------------
const D3DFCS_UNKNOWN: [DXGI_FORMAT; 1] = [DXGI_FORMAT_UNKNOWN]; // not part of cast set, just the "null terminator"];
const D3DFCS_R32G32B32A32: [DXGI_FORMAT; 5] = [
...
const D3DFCS_R32G32B32: [DXGI_FORMAT; 5] = [
...
const D3DFCS_R16G16B16A16: [DXGI_FORMAT; 7] = [
...
const D3DFCS_R32G32: [DXGI_FORMAT; 5] = [
...
const D3DFCS_R32G8X24: [DXGI_FORMAT; 5] = [
...
const D3DFCS_R11G11B10: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_R11G11B10_FLOAT,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_R8G8B8A8: [DXGI_FORMAT; 7] = [
...
const D3DFCS_R16G16: [DXGI_FORMAT; 7] = [
...
const D3DFCS_R32: [DXGI_FORMAT; 6] = [
...
const D3DFCS_R24G8: [DXGI_FORMAT; 5] = [
...
const D3DFCS_R8G8: [DXGI_FORMAT; 6] = [
...
const D3DFCS_R16: [DXGI_FORMAT; 8] = [
...
const D3DFCS_A8: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_A8_UNORM,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_R1: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_R1_UNORM,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_R9G9B9E5: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_R9G9B9E5_SHAREDEXP,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_R8G8_B8G8: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_R8G8_B8G8_UNORM,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_G8R8_G8B8: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_G8R8_G8B8_UNORM,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_BC1: [DXGI_FORMAT; 4] = [
...
const D3DFCS_BC2: [DXGI_FORMAT; 4] = [
...
const D3DFCS_BC3: [DXGI_FORMAT; 4] = [
...
const D3DFCS_BC4: [DXGI_FORMAT; 4] = [
...
const D3DFCS_BC5: [DXGI_FORMAT; 4] = [
...
const D3DFCS_B5G6R5: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_B5G6R5_UNORM,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_B5G5R5A1: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_B5G5R5A1_UNORM,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_B8G8R8A8: [DXGI_FORMAT; 4] = [
...
const D3DFCS_B8G8R8X8: [DXGI_FORMAT; 4] = [
...
const D3DFCS_R10G10B10A2: [DXGI_FORMAT; 5] = [
...
const D3DFCS_BC6H: [DXGI_FORMAT; 4] = [
...
const D3DFCS_BC7: [DXGI_FORMAT; 4] = [
...
const D3DFCS_AYUV: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_AYUV,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_NV12: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_NV12,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_YUY2: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_YUY2,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_P010: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_P010,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_P016: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_P016,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_NV11: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_NV11,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_420_OPAQUE: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_420_OPAQUE,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_Y410: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_Y410,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_Y416: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_Y416,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_Y210: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_Y210,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_Y216: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_Y216,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_AI44: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_AI44,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_IA44: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_IA44,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_P8: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_P8,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_A8P8: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_A8P8,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_B4G4R4A4: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_B4G4R4A4_UNORM,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_P208: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_P208,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_V208: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_V208,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_V408: [DXGI_FORMAT; 2] = [
    DXGI_FORMAT_V408,
    DXGI_FORMAT_UNKNOWN, // not part of cast set, just the "null terminator"
];

const D3DFCS_A4B4G4R4: [DXGI_FORMAT; 2] = [
...
const s_FormatDetail: [FORMAT_DETAIL; 192] = [
